    ...
    <div className="relative">
      <div className="w-full max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-16 pt-24">
        <motion.h1
          ...
          viewport={{ once: true }}
          className="mb-6 text-2xl sm:text-3xl lg:text-4xl text-white font-semibold text-center overflow-hidden"
        >
        ...
        <div className="grid grid-cols-1 gap-y-16 gap-x-6 pt-32">
          <motion.div
            ...
            className="w-full h-[300px] lg:h-[500px] rounded-xl shadow-sm relative border-[0.5px] border-neutral-700"
          >
            <motion.div
            ...
            >
              <div className="text-sm">
                ...
                <p className="text-gray-600">
                  This chart visualizes the comparison between scenarios with
                  and without the specified effect.
                </p>
                <div className="mt-2">
                ...
                <div className="flex gap-2 items-center mt-3">
                  <span className="bg-red-400 w-3 h-3 inline-block"></span>
                  <span className="text-xs">Baseline (No Effect)</span>
                </div>
                <div className="flex gap-2 items-center mt-1">
                  <span className="bg-blue-400 w-3 h-3 inline-block"></span>
                  <span className="text-xs">Adjusted (With Effect)</span>
                </div>
              </div>
            </motion.div>
            <ResponsiveContainer
