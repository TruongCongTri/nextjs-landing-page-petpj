      ...
      <div className="w-full max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-16 grid grid-cols-1 lg:grid-cols-2 gap-y-12 pt-32">
        <div className="lg:pr-16 overflow-hidden">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-2xl sm:text-3xl lg:text-4xl text-white max-w-md font-semibold">
              The missing standard library for TypeScript
            </h2>
            <p className="mt-6 mb-3 max-w-xl font-light text-zinc-400">
              TypeScript/JavaScript, the most popular programming language, is
              still missing a standard library. Effect is filling this gap by
              providing a solid foundation of data structures, utilities, and
              abstractions to make building applications easier.
            </p>
          ...
          >
            ...
            <motion.ul variants={wrapper} className="relative mt-6 space-y-3">
              ...
              <motion.li variants={list} className="relative w-full">
                <div
                  className="absolute inset-0 bg-zinc-700 rounded-r-md"
                  style={{ opacity: "85%", width: "63.760829207920786%" }}
                ></div>
                <div className="relative items-center text-sm text-white px-2 w-full flex gap-4 h-6 whitespace-nowrap justify-between">
              ...
              <motion.li variants={list} className="relative w-full">
                <div
                  className="absolute inset-0 bg-zinc-700 rounded-r-md"
                  style={{ opacity: "70%", width: "50.39449257425742%" }}
                ></div>
                <div className="relative items-center text-sm text-white px-2 w-full flex gap-4 h-6 whitespace-nowrap justify-between">
              ...
              <motion.li variants={list} className="relative w-full">
                <div
                  className="absolute inset-0 bg-zinc-700 rounded-r-md"
                  style={{ opacity: "55%", width: "45.3279702970297%" }}
                ></div>
                <div className="relative items-center text-sm text-white px-2 w-full flex gap-4 h-6 whitespace-nowrap justify-between">
              ...
              <motion.li variants={list} className="relative w-full">
                <div
                  className="absolute inset-0 bg-zinc-700 rounded-r-md"
                  style={{ opacity: "40%", width: "37.68564356435643%" }}
                ></div>
                <div className="relative items-center text-sm text-white px-2 w-full flex gap-4 h-6 whitespace-nowrap justify-between">
