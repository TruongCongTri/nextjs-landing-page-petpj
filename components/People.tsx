                ...
                <motion.div variants={wrapper} initial='hidden' whileInView='visible' viewport={{once:true}} className='h-28 flex justify-between'>
                    <motion.div variants={item} className='h-full flex items-center'>
                        <div className='relative h-8 w-8'>
                            <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                <Image src='/images/avatar1.webp' alt='Avatar-Image' width={100} height={100}/>
                            </div>
                        </div>
                    </motion.div>
                    <motion.div variants={item} className=' h-full flex items-start'>
                        <div className='relative h-14 w-14'>
                            <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                <Image src='/images/avatar2.webp' alt='Cont-Image' width={100} height={100}/>
                            </div>
                        </div>
                    </motion.div>
                    <motion.div variants={item} className=' h-full flex items-end'>
                        <div className='relative h-16 sm:h-20 w-16 sm:w-20'>
                            <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                <Image src='/images/avatar3.webp' alt='Cont-Image' width={100} height={100}/>
                            </div>
                        </div>
                    </motion.div>
                    <motion.div variants={item} className='hidden sm:flex h-full items-end'>
                        <div className='relative h-14 w-14'>
                            <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                <Image src='/images/avatar4.webp' alt='Cont-Image' width={100} height={100}/>
                            </div>
                        </div>
                    </motion.div>
                    <motion.div variants={item} className='hidden sm:flex h-full items-start'>
                        <div className='relative h-8 w-8'>
                            <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                <Image src='/images/avatar5.webp' alt='Cont-Image' width={100} height={100}/>
                            </div>
                        </div>
                    </motion.div>
                    <motion.div variants={item} className='hidden sm:flex h-full  items-end'>
                        <div className='relative h-14 w-14'>
                            <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                <Image src='/images/avatar6.webp' alt='Cont-Image' width={100} height={100}/>
                            </div>
                        </div>
                    </motion.div>
                    <motion.div variants={item} className='hidden sm:flex h-full items-start'>
                        <div className='relative h-14 w-14'>
                            <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                <Image src='/images/avatar7.webp' alt='Cont-Image' width={100} height={100}/>
                            </div>
                        </div>
                    </motion.div>
                    <motion.div variants={item} className='hidden sm:flex h-full items-center'>
                        <div className='relative h-8 w-8'>
                            <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                <Image src='/images/avatar8.webp' alt='Cont-Image' width={100} height={100}/>
                            </div>
                        </div>
                    </motion.div>
                </motion.div>
                    ...
                    <div className='grow sm:w-1/3 lg:w-2/5'>
                        <motion.div initial='hidden' whileInView='visible' viewport={{once:true}} variants={wrapper} className='flex justify-around h-24'>
                            <motion.div variants={item} className=' h-full flex items-start'>
                                <div  className='relative h-14 w-14'>
                                    <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                        <Image src='/images/avatar9.webp' alt='Cont-Image' width={100} height={100}/>
                                    </div>
                                </div>
                            </motion.div>
                            <motion.div variants={item} className=' h-full flex items-end'>
                                <div className='relative h-8 w-8'>
                                    <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                        <Image src='/images/avatar10.webp' alt='Cont-Image' width={100} height={100}/>
                                    </div>
                                </div>
                            </motion.div>
                            <motion.div variants={item} className=' h-full flex items-center'>
                                <div className='relative h-14 w-14'>
                                    <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                        <Image src='/images/avatar11.webp' alt='Cont-Image' width={100} height={100}/>
                                    </div>
                                </div>
                            </motion.div>
                        </motion.div>
                    ...
                    <div className='grow sm:w-1/3 lg:w-2/5'>
                        <motion.div initial='hidden' whileInView='visible' viewport={{once:true}} variants={wrapper} className='flex justify-around h-24'>
                            <motion.div variants={item} className=' h-full flex items-start'>
                                <div className='relative h-14 w-14'>
                                    <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                        <Image src='/images/avatar12.webp' alt='Cont-Image' width={100} height={100}/>
                                    </div>
                                </div>
                            </motion.div>
                            <motion.div variants={item} className=' h-full flex items-end'>
                                <div className='relative h-8 w-8'>
                                    <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                        <Image src='/images/avatar13.webp' alt='Cont-Image' width={100} height={100}/>
                                    </div>
                                </div>
                            </motion.div>
                            <motion.div variants={item} className=' h-full flex items-center'>
                                <div className='relative h-14 w-14'>
                                    <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                        <Image src='/images/avatar14.webp' alt='Cont-Image' width={100} height={100}/>
                                    </div>
                                </div>
                            </motion.div>
                        </motion.div>
